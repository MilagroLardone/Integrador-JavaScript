  ...
  if (cursosGuardados) {
    cursosGuardados.forEach(cursoGuardado => {
      ...
      <div class="estudiantes">
        ...
        ${cursoGuardado.listarEstudiantes()}
      </div>
    `; 
...
// Inicialización: cargar datos desde LocalStorage o crear datos de ejemplo
function inicializarDatos() {
  cargarCursosDesdeLocalStorage();  // Cargar cursos desde LocalStorage
